...
namespace Farscape {
    ...
    void Renderer2D::Init()
    {
        ...
        s_Data.TextureShader = Shader::Create(std::string(ASSETS_PATH) + "/shaders/Renderer2D.glsl");
        ...
        // Lines
        s_Data.LineShader = Shader::Create(std::string(ASSETS_PATH) + "/shaders/Renderer2D_Line.glsl");
